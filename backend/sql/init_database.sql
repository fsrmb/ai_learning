...
('数据库', 'MySQL、Redis、MongoDB、数据库设计等', 'DatabaseIcon', 'DATABASE', 2, 1, 3, '2024-01-12 10:00:00', '2024-01-12 10:00:00'),
('算法与数据结构', '常用算法、刷题技巧、面试算法题', 'AlgorithmIcon', 'ALGORITHM', 4, 1, 4, '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
('移动开发', 'HarmonyOS、iOS、Android 移动端开发', 'MobileIcon', 'MOBILE', 3, 1, 5, '2024-02-01 10:00:00', '2024-02-01 10:00:00');
